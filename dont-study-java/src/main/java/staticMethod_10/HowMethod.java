...
class PerimeterMath { //둘레 계산
	...
	public double calRectangPeri(double width, double height) {
		SimpleMath sm = new SimpleMath();
...
class HowMethod {
	public static void main(String[] args) {
		...
		System.out.println("직사각형 둘레 : "+pm.calRectangPeri(2.0, 4.0));
	}
